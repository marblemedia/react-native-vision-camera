...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    "GCC_PREPROCESSOR_DEFINITIONS" => "$(inherited) SK_METAL=1 SK_GANESH=1 VISION_CAMERA_ENABLE_FRAME_PROCESSORS=#{enableFrameProcessors}",
    "OTHER_SWIFT_FLAGS" => "$(inherited) #{enableFrameProcessors ? "-D VISION_CAMERA_ENABLE_FRAME_PROCESSORS" : ""}",
